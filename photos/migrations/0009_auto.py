...
class Migration(SchemaMigration):
    ...
    models = {
        'photos.collection': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photos.Photo']", 'through': "orm['photos.PhotoToCollection']", 'symmetrical': 'False'})
        },
        'photos.photo': {
            'Meta': {'object_name': 'Photo'},
            'collections': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photos.Collection']", 'through': "orm['photos.PhotoToCollection']", 'symmetrical': 'False'}),
