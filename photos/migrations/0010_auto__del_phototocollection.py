...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoToCollection.order'
        db.add_column('photos_phototocollection', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding index on 'PhotoToCollection', fields ['order']
        db.create_index('photos_phototocollection', ['order'])


    def backwards(self, orm):
        # Deleting field 'PhotoToCollection.order'
        db.delete_column('photos_phototocollection', 'order')

        # Removing index on 'Photo', fields ['width']
        db.delete_index('photos_phototocollection', ['order'])
    ...
    models = {
        ...
        'photos.photo': {
            ...
            'collections': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photos.Collection']", 'symmetrical': 'False'}),
